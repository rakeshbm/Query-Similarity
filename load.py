# -*- coding: utf-8 -*-
"""
Created on Fri Apr  5 15:16:53 2019
...
def load_dataset(dataset_path_train,word2idx):
	...
	with open(dataset_path_train,'r', encoding="utf-8") as file1:
		...
		for index, line in enumerate(file1):
			...
			sentence_one.append(np.pad(s_1,(0,100-len(s_1)),'constant',constant_values=(0)))
			sentence_two.append(np.pad(s_2,(0,100-len(s_2)),'constant',constant_values=(0)))
